...
#fetch https://raw.githubusercontent.com/mrroundrobin/opnazure/dev_active_active/scripts/$1
#fetch https://raw.githubusercontent.com/mrroundrobin/opnazure/master/scripts/$1
